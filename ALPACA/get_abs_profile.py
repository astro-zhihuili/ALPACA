...
def get_abs_profile(alpha, Fv, vinf, gamma, logNcl_0, rand_v, varr_axis, 
                    nbins = 9900, rcl = 100 * pc, rmin = 1000 * pc, rmax = 100000 * pc):

    '''This function takes in a set of physical parameters of the clumps and returns four 2D arrays for the DTB absorption spectrum.
    ...
    return np.flip(-varr_axis / kms), prob_arr_2d